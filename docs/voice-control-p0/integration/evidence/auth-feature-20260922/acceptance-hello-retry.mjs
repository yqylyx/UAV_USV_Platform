...
await page.addInitScript(()=>{
 ...
 window.__droppedHellos=0;
 window.addEventListener('message',e=>{let d=e.data;try{if(typeof d==='string')d=JSON.parse(d)}catch{return}const m=d?.message??d;if(m?.type==='PRESENTATION_HELLO'&&window.__droppedHellos<3){window.__droppedHellos++;e.stopImmediatePropagation();}},true);
});
const diagnostics=[];
